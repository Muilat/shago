...
class Index extends Component {
  render() {
      ...
      <Layout>
        <div>
          <div className="site-blocks-cover" style={{backgroundImage: 'url(/static/images/hero_1.jpg)'}} data-aos="fade">
            ...
            <div className="container">
              ...
              <div className="row align-items-center">
                <div className="col-md-12 col-lg-7 mb-5">
                  <a href="#"><img src="/static/images/blog_1.jpg" alt="Image placeholder" className="img-fluid rounded" /></a>
                </div>
